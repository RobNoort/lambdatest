...
import nl.robnoort.helpers.Person;
...
public class Lambdas {
    ...
    public void someBiFunction12Executor(BiFunction<Integer, Integer, Integer> fn) {
    ...
    public void someLambdaMethodCaller() {
        ...
        someBiFunction12Executor(add);

        // outputs "Result of fn(1, 2) is 2"
        someBiFunction12Executor(multiply);
    }
